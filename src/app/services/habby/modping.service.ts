...
// Active hours = 8am to 4pm local time (8-hour window)
// Users select 2–3 groups to cover their full daily availability
...
const TIMEZONE_GROUPS: {
...
}[] = [
	{
		...
		activeEndUTC: 2, // 4pm UTC-10 (wraps)
		activeLocalTime: transformToLocalTime(18, 2),
	},
	{
		slug: 'east-americas',
		label: 'East Americas',
		...
		activeEndUTC: 21, // 4pm UTC-5
		activeLocalTime: transformToLocalTime(13, 21),
	},
	{
		slug: 'europe-africa',
		label: 'Europe & Africa',
		...
		activeEndUTC: 15, // 4pm UTC+1
		activeLocalTime: transformToLocalTime(7, 15),
	},
	{
		...
		activeEndUTC: 11, // 4pm UTC+5
		activeLocalTime: transformToLocalTime(3, 11),
	},
	{
		slug: 'asia-pacific',
		label: 'Asia & Pacific',
		...
		activeEndUTC: 6, // 4pm UTC+10 (wraps)
		activeLocalTime: transformToLocalTime(22, 6),
	},
]
